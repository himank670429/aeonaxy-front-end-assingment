	...
	return (
		<div className="flex flex-col">
			...
			<main className="text-gray-base flex flex-col gap-4 items-center my-12 text-center px-4">
				<span className="text-black text-2xl font-bold sm:text-3xl md:text-4xl">Please verify your email...</span>
				<div className="relative">
					<FontAwesomeIcon className="text-[100px]" icon={faEnvelope} />
					<FontAwesomeIcon className="absolute text-pink-active bg-white border-4 text-3xl border-white top-[.0.5em] right-[-.5em] rounded-full" icon={faCircleCheck} />
				</div>
				<p>please verify the confirmation email we just sent to:</p>
				<b className="text-black">{"account@refro.design"}</b>
				...
				<p>
					...
					by a filter. if<br /> you still dont see it, you can{" "}
